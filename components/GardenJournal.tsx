...
import { Plus, Droplets, Calendar, Camera, AlertCircle, Clock, CheckCircle, ArrowLeft, RefreshCw, ScanLine, X } from 'lucide-react';
...
export const GardenJournal: React.FC<GardenJournalProps> = ({ plants, onUpdatePlant, onScanNew }) => {
           ...
           <div className="flex flex-row sm:flex-col items-end gap-3 w-full sm:w-auto justify-between sm:justify-start">
             ...
             <div className="flex gap-2">
                 ...
                 <button 
                   ...
                   className={`flex items-center gap-2 px-5 py-2.5 rounded-lg transition-all shadow-md font-medium min-w-[140px] justify-center ${
                     wateringState === 'DONE' 
            ...
            >
                ...
                <div className="p-4 flex justify-between items-center bg-white">
                    ...
                    <button 
                        ...
                        className={`p-2.5 rounded-full transition-all z-10 relative shadow-sm hover:scale-110 active:scale-95 ${
